...
use crate::gene::Gene;
use crate::u64s::{self, U64s, U64sStruct};
...
impl FromStr for Zygote {
    ...
    fn from_str(s: &str) -> Result<Zygote, String> {
        ...
        let values_bit_chars: String = filtered
            ...
            .collect();
        let dominance = dominance_bit_chars.parse::<U64sStruct>().unwrap();
        let values = values_bit_chars.parse::<U64sStruct>().unwrap();
        Result::Ok(Zygote::new(dominance, values))
    }
}
